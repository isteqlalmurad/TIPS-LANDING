...
export default function RequestPilotPage() {
  ...
  async function onSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    const payload = {
      ...
      courseBlock: String(data.get("courseBlock") || ""),
      startDate: String(data.get("startDate") || ""),
      signOffContact: String(data.get("signOffContact") || ""),
  ...
  return (
    <main className="v2-page" style={{ background: "var(--v2-ink)", minHeight: "100vh" }}>
      ...
      >
        ...
        >
          <div style={{ marginBottom: 30 }}>
            ...
            >
              Tell us about your cohort and we&rsquo;ll scope a pilot, including
              org setup, your marking scheme, and a written report at the end.
            </p>
          </div>
          ...
          >
            {status === "ok" ? (
              ...
              >
                ...
                >
                  Thanks. We&rsquo;ll review the details and come back within 24
                  hours to confirm scope and a start date.
                </p>
              </div>
            ) : (
              <form
              ...
              >
                ...
                <Field label="Cohort size" name="cohortSize" placeholder="e.g. 80 students" />
                <Field label="Course or block" name="courseBlock" placeholder="e.g. Year 3 GP block, OSCE prep" />
                <Field label="Target start date" name="startDate" placeholder="e.g. Start of next term" />
                <Field label="Sign-off contact" name="signOffContact" placeholder="Who else needs to approve this?" />
                ...
                <div style={{ gridColumn: "1 / -1" }}>
                  ...
                  <textarea
                    ...
                    name="message"
                    rows={5}
                    placeholder="e.g. existing marking scheme, integration constraints, who's involved on your side..."
                    style={inputStyle({ minHeight: 130, resize: "vertical" })}
                    className="pilot-request-input"
                  />
                </div>
                ...
                <button
                  ...
                  className="pilot-request-submit"
                >
                  {status === "submitting" ? (
                    "Sending..."
                  ) : (
                    <>
                      Request pilot <ArrowRight size={16} strokeWidth={2} />
                    </>
                  )}
                </button>
      ...
      <style jsx>{`
        :global(.pilot-request-input:focus) {
          border-color: #0891B2 !important;
          box-shadow: 0 0 0 3px rgba(8, 145, 178, 0.12) !important;
        }
        :global(.pilot-request-submit:hover:not(:disabled)) {
